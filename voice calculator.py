...
def audio():
    mixer.music.load("E:\PYTHON PROGRAMMINGS\music1.mp3")
    mixer.music.play()
    ...
    with speech_recognition.Microphone()as m:
        try:
            ...
            mixer.music.load("E:\PYTHON PROGRAMMINGS\music2.mp3")
            mixer.music.play()
...
logoImage = PhotoImage(file="E:\PYTHON PROGRAMMINGS\logo.png")
...
micImage = PhotoImage(file="E:\PYTHON PROGRAMMINGS\microphone.png")
